...
import type { Prisma, PrismaClient } from 'prisma/commerce/generated/vendoCommerce';
...
export type PrismaQuery<T extends PrismaModel = PrismaModel> = WhereInput<ExtractModelName<T, ModelName>> &
